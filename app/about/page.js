        ...
        <div className="grid md:grid-cols-1 gap-6">
          ...
          <div className="bg-[#131a2c] rounded-lg p-6 space-y-4">
            ...
            <p className="text-gray-300 text-sm">
              Read what clients and colleagues say about their experience working with me on various projects.
            </p>
            <Link href="#" className="text-green-400 flex items-center gap-1 text-sm ">
