      ...
      <div className="max-w-4xl mx-auto">
...

        {
            internshipItems.length === 0 && (
                ...
                <h3 className="text-xl mb-2 text-purple-400 font-bold">No Internship Experience Yet</h3>
                <p className="text-slate-400 max-w-md mx-auto">
                    Stay tuned! I&apos;ll be sharing my internship experiences and projects soon. Check back later.
                </p>
                </div>
            )
        }
